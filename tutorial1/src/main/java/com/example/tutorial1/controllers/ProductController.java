...
public class ProductController {
   ...
   private static final List<Map<String, String>> products = new ArrayList<>(List.of(
       Map.of("id", "1", "name", "TV", "description", "Best TV", "price", "666"),
       Map.of("id", "2", "name", "iPhone", "description", "Best iPhone", "price", "9999999"),
       Map.of("id", "3", "name", "Chromecast", "description", "Best Chromecast", "price", "1"),
 ...
 @GetMapping("/products/create")
   ...
   public String save(@Valid @ModelAttribute("productForm") ProductForm productForm, BindingResult result, Model model) {
       ...
       return "redirect:/products/succes";
   }

   @GetMapping("/products/succes")
